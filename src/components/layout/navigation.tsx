        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input type="text" placeholder="Search designs..." className="w-48 h-9 pl-10 pr-4 text-sm border border-gray-300 rounded-full bg-gray-50 focus:outline-none focus:border-orange-500" />
            </div>
            ...
            <button className="relative text-gray-600">
              ...
              {cartCount > 0 && <span className="absolute -top-1 -right-1 w-5 h-5 bg-orange-600 text-white text-xs rounded-full flex items-center justify-center">{cartCount}</span>}
            </button>
          </div>
        </div>
      </div>
