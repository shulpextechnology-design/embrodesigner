...
export default function BrowsePage() {
  ...
  switch (sortBy) {
    case "newest":
      ...
      break;
    case "popular":
      filteredDesigns.sort((a, b) => b.favorites - a.favorites);
      break;
    case "price-low":
                ...
                <Link key={design.id} href={`/design/${design.id}`} className="group">
                  <div className="overflow-hidden rounded bg-white">
                    <div className="relative aspect-square bg-[#f5f5f5]">
                      <Image src={design.thumbnail} alt={design.title} fill className="object-cover" sizes="(max-width: 640px) 50vw, 25vw" />
                      {isNew && (
                    ...
                    <div className="border border-t-0 border-[#e6e6e6] p-3">
                      <p className="mb-0.5 text-[11px] text-[#999999]">SKU: {design.id.toUpperCase()}</p>
